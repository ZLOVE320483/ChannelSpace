...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int selectedTabTextColor = 0xFF06bf04;
    ...
    public void reSetTabTitle(int position, String title) {
        View reTab = tabsContainer.getChildAt(position);
        if (reTab instanceof TextView) {
            ((TextView) reTab).setText(title);
        }
    }

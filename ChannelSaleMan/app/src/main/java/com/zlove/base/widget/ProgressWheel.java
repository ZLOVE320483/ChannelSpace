...
public class ProgressWheel extends View {
    ...
    private int barColor = 0xfe6500;
    private int circleColor = 0xfe6500;
    private int rimColor = 0xfe6500;
    private int textColor = 0xfe6500;
    ...
    private void setupBounds() {
        ...
        rectBounds = new RectF(paddingLeft, paddingTop, this.getLayoutParams().width
                - paddingRight, this.getLayoutParams().height - paddingBottom);
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.ProgressWheel_wheelWidth, barWidth);
        ...
        barLength = (int) a.getDimension(R.styleable.ProgressWheel_wheelLength, barLength);
        ...
        circleColor = (int) a
                .getColor(R.styleable.ProgressWheel_circleColor, circleColor);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle((circleBounds.width() / 2) + rimWidth + paddingLeft,
                (circleBounds.height() / 2) + rimWidth + paddingTop, circleRadius,
                circlePaint);
     ...
     */
    public void incrementProgress(int prgressParam) {
        isSpinning = false;
        progress = prgressParam * 360 / 100;
        setText((prgressParam) + "%");
        spinHandler.sendEmptyMessage(0);
    }
    ...
    public void setProgress(int i) {
        ...
        progress = i;
        spinHandler.sendEmptyMessage(0);
        // setText(Math.round(((float)progress)*100) + "%");
    }

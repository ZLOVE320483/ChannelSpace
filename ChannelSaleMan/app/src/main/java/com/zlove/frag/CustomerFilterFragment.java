...
public class CustomerFilterFragment extends BaseFragment implements OnClickListener {
    ...
    protected int getInflateLayout() {
        return R.layout.frag_customer_filter;
    }
    ...
    protected void setUpView(View view) {
        ...
        LogUtil.d("ZLOVE", "isDisable---111---" + isDisable);
    ...
    private void onConfirmClick() {
        ...
        LogUtil.d("ZLOVE", "isDisable---222---" + isDisable);

...
public class PwdFindBackFragment extends BaseFragment implements OnClickListener, ConfirmAction {
    ...
    class GetVerifyCodeHandler extends HttpResponseHandlerFragment<PwdFindBackFragment> {
        ...
        public GetVerifyCodeHandler(PwdFindBackFragment context) {
            super(context);
        }
    ...
    class CheckPhoneCodeHandler extends HttpResponseHandlerFragment<PwdFindBackFragment> {

        public CheckPhoneCodeHandler(PwdFindBackFragment context) {
            super(context);
        }
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] content) {
            ...
            if (content != null) {
                ...
                if (bean != null) {
                    if (bean.getStatus() == 200) {
                        Intent intent = new Intent(getActivity(), ActPwdFindBackNext.class);
                        intent.putExtra(IntentKey.INTENT_KEY_USER_PHONE, account);
                        intent.putExtra(IntentKey.INTENT_KEY_USER_VERIFY_CODE, verifyCode);

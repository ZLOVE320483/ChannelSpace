...
public class PwdFindBackNextFragment extends BaseFragment implements OnClickListener {
    ...
    protected void setUpView(View view) {
        if (getActivity().getIntent() != null) {
            ...
            if (intent.hasExtra(IntentKey.INTENT_KEY_USER_VERIFY_CODE)) {
				code = intent.getStringExtra(IntentKey.INTENT_KEY_USER_VERIFY_CODE);
			}
        }
    ...
    private void onFindPwdClick() {
        ...
        UserHttpRequest.userUpdateNewPwdRequest(account, password, code, new UpdateNewPwdHandler(this));
    }
    
    class UpdateNewPwdHandler extends HttpResponseHandlerFragment<PwdFindBackNextFragment> {

        public UpdateNewPwdHandler(PwdFindBackNextFragment context) {
            super(context);
        }

...
public class ProjectImgDetailLayoutFragment extends BaseFragment {
	...
	protected int getInflateLayout() {
		return R.layout.frag_project_img_detail_layout;
	}
	...
	protected void setUpView(View view) {
        ...
        if (!ListUtils.isEmpty(imgUrls)) {
            ...
            for(int i = 0; i < projectImgs.length; i++){
                ...
                int n = Integer.MAX_VALUE / 2 % imgSize;
        ...
        viewPager.setOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int arg0) {
                tvCount.setText((arg0 % imgSize  + 1) + "/" + imgSize);
            }
        ...
        public Object instantiateItem(ViewGroup container, int position) {
          //对ViewPager页号求模取出View列表中要显示的项
            if (imgUrls.size() > 0) {
                ...
                if (position< 0){
                    position = imgUrls.size() + position;
                }

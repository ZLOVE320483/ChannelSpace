...
public class ChannelCookie {
    ...
    protected void readUserInfo(SharedPreferences sp) {
        ...
        this.currentCityId = sp.getString(ChannelConstant.SharePreKey.KEY_USER_CURRENT_CITY_ID,"");
        this.currentCityName = sp.getString(ChannelConstant.SharePreKey.KEY_USER_CURRENT_CITY_NAME,"");
    ...
    public void saveUserCurrentCityName(String cityName) {
        ...
        Editor editor = getUserInfoSharedPre(ApplicationUtil.getApplicationContext()).edit();
        editor.putString(ChannelConstant.SharePreKey.KEY_USER_CURRENT_CITY_NAME, cityName);
        editor.commit();
    }
    ...
    public void clearUserInfo() {
        ...
        editor.clear();
        editor.putString(ChannelConstant.SharePreKey.KEY_USER_ACCOUNT, account);
        editor.putString(ChannelConstant.SharePreKey.KEY_USER_CURRENT_CITY_ID, currentCityId);
        editor.putString(ChannelConstant.SharePreKey.KEY_USER_CURRENT_CITY_NAME, currentCityName);
        editor.commit();
    }

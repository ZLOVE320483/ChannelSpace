...
public class NaviStartActivity extends Activity implements OnClickListener, OnCheckedChangeListener, OnMapClickListener {
    ...
    private AMapLocationListener mLocationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation location) {
            if (location != null && location.getAMapException().getErrorCode() == 0) {
                ...
                mGPSMarker.setPosition(new LatLng(mStartPoint.getLatitude(), mStartPoint.getLongitude()));
                mStartPoints.clear();
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        mPositionAdapter = new ArrayAdapter<String>(this, R.layout.strategy_inputs, mPositionMethods);
    ...
    private void initResources() {
        ...
        mStrategyMethods = new String[] { res.getString(R.string.navi_strategy_speed), res.getString(R.string.navi_strategy_cost),
            res.getString(R.string.navi_strategy_distance), res.getString(R.string.navi_strategy_nohighway),
            res.getString(R.string.navi_strategy_timenojam), res.getString(R.string.navi_strategy_costnojam) };
        mPositionMethods = new String[] { res.getString(R.string.mypoistion), res.getString(R.string.mappoistion) };
    ...
    private void initMapAndNavi() {
        ...
        // 初始化Marker添加到地图
        mStartMarker = mAmap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(),
            R.drawable.start))));
        mWayMarker = mAmap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(),
            R.drawable.way))));
        mEndMarker = mAmap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(),
            R.drawable.end))));
        mGPSMarker = mAmap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource(getResources(),
            R.drawable.location_marker))));
        
        mAmap.moveCamera(CameraUpdateFactory.newLatLngZoom(IntentKey.testEndPoi, 12));
        ...
        if (mAmapNaviListener == null) {
            ...
            mAmapNaviListener = new AMapNaviListener() {
                ...
                public void onCalculateRouteSuccess() {
                    ...
                    switch (mNaviMethod) {
                        case ROUTE_METHOD:
                            Intent intent = new Intent(NaviStartActivity.this, NaviRouteActivity.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                            startActivity(intent);

                            break;
                        case NAVI_METHOD:
                            Intent standIntent = new Intent(NaviStartActivity.this, NaviEmulatorActivity.class);

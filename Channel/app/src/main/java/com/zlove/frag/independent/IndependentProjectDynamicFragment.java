...
public class IndependentProjectDynamicFragment extends BaseFragment implements OnItemClickListener, PullableViewListener {
    ...
    public void onResume() {
    	super.onResume();if (ListUtils.isEmpty(infos)) {
    ...
    class GetProjectNewsListHandler extends HttpResponseHandlerFragment<IndependentProjectDynamicFragment> {
		...
		public GetProjectNewsListHandler(IndependentProjectDynamicFragment context, LOAD_ACTION action) {
			super(context);
			this.action = action;
		}

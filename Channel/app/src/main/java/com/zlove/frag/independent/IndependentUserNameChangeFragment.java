...
public class IndependentUserNameChangeFragment extends BaseFragment implements OnClickListener {
    ...
    class ChangeUserNameHandler extends HttpResponseHandlerFragment<IndependentUserNameChangeFragment> {
        ...
        public ChangeUserNameHandler(IndependentUserNameChangeFragment context) {
            super(context);
        }

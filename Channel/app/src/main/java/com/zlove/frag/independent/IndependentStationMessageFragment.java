...
import com.zlove.adapter.independent.StationMessageAdapter;
...
public class IndependentStationMessageFragment extends BaseFragment implements OnItemClickListener, PullableViewListener {
	...
	class GetStationMessageListHandler extends HttpResponseHandlerFragment<IndependentStationMessageFragment> {
		private LOAD_ACTION action;
		
		public GetStationMessageListHandler(IndependentStationMessageFragment context, LOAD_ACTION action) {
			super(context);
			this.action = action;
		}

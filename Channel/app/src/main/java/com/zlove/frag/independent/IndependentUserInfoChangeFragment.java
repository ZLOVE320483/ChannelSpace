...
public class IndependentUserInfoChangeFragment extends BaseFragment implements OnClickListener, PhotoSelectListener, GenderSelectListener {
    ...
    protected void setUpView(View view) {
        ...
        userPhoneView = view.findViewById(R.id.id_modify_account);
        ...
        userPhoneView.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (v == avatarView) {
            DialogManager.showPhotoDialog(getActivity(), IndependentUserInfoChangeFragment.this);
        } else if (v == userNameView) {
            Intent intent = new Intent(getActivity(), ActIndependentUserNameChange.class);
            startActivityForResult(intent, IntentKey.REQUEST_CODE_CHANGE_USER_NAME);
        } else if (v == userGenderView) {
            DialogManager.showGenderDialog(getActivity(), IndependentUserInfoChangeFragment.this);
        } else if (v == userPhoneView) {
    ...
    class ChangeUserGenderHandler extends HttpResponseHandlerFragment<IndependentUserInfoChangeFragment> {
        ...
        public ChangeUserGenderHandler(IndependentUserInfoChangeFragment context) {
            super(context);
        }
    ...
    class ChangeAvatarHandler extends HttpResponseHandlerFragment<IndependentUserInfoChangeFragment> {
        ...
        public ChangeAvatarHandler(IndependentUserInfoChangeFragment context) {
            super(context);
        }

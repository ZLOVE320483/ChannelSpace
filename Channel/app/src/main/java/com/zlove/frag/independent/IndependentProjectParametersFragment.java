...
public class IndependentProjectParametersFragment extends BaseFragment {
    ...
    protected int getInflateLayout() {
        return R.layout.frag_independent_project_paramter;
    }
    ...
    protected void setUpView(View view) {
        ...
        ProjectHttpRequest.requestProjectParams(projectId, new GetProjectParamsHandler(this));
    }
    
    class GetProjectParamsHandler extends HttpResponseHandlerFragment<IndependentProjectParametersFragment> {

		public GetProjectParamsHandler(
				IndependentProjectParametersFragment context) {
			super(context);
		}

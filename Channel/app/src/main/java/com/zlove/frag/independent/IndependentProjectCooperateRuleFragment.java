...
public class IndependentProjectCooperateRuleFragment extends BaseFragment implements OnItemClickListener {
	...
	protected void setUpView(View view) {
		...
		ProjectHttpRequest.requestProjectRuleList(projectId, "0", "10", new GetProjectRuleListHandler(this));
	}
    ...
    class GetProjectRuleListHandler extends HttpResponseHandlerFragment<IndependentProjectCooperateRuleFragment> {
        ...
        public GetProjectRuleListHandler(IndependentProjectCooperateRuleFragment context) {
            super(context);
        }

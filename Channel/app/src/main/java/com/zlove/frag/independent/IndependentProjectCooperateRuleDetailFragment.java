...
public class IndependentProjectCooperateRuleDetailFragment extends BaseFragment {
    ...
    class GetProjectRuleDetailHandler extends HttpResponseHandlerFragment<IndependentProjectCooperateRuleDetailFragment> {

		public GetProjectRuleDetailHandler(IndependentProjectCooperateRuleDetailFragment context) {
			super(context);
		}
